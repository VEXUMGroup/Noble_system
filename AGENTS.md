...
> 最優先ルール: Codex は作業開始前と各対話の回答前に `CLAUDE (1).md` を必ず確認し、その内容に従うこと。
> `AGENTS.md` と `CLAUDE (1).md` の内容が競合する場合は、`CLAUDE (1).md` を優先する。
> 特に `development-logs/YYYYMMDD-devlogs.md` への 1対話1記録、DoD、エラー全文記録、設計書・仕様書運用は必須とする。

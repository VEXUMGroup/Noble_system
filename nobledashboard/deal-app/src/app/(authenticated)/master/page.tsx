...
export default function MasterPage() {
  ...
  // ── 認証チェック ──
  // layout.tsx で既に role が確認されているので、Context から取得したユーザー情報を使用
  useEffect(() => {
    console.log('[Master] User from Context:', {
      id: currentUser.id,
    ...
    console.log('[Master] Role check - role:', currentUser.role, 'isManager:', isManager);
